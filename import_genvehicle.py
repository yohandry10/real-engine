...
for f in FILES:
    ...
    # Conserva los VERTEX COLORS del FBX (vehiculos UNLIT vertex-color, como ciudades/terreno).
...
unreal.log("WL_GENVEHICLE_RESULT_BEGIN")
for a in unreal.EditorAssetLibrary.list_assets(DEST, True, False):
    unreal.log("WL_GENVEHICLE_ASSET: " + a)
unreal.log("WL_GENVEHICLE_RESULT_END")
